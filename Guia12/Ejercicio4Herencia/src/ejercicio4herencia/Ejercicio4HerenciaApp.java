...
public class Ejercicio4HerenciaApp {

    public static void main(String[] args) {
        Rectangulo rec = new Rectangulo(8, 5);
        Circulo cir = new Circulo(4);
        
        System.out.println("El perimetro del Rectángulo es: "+rec.calcularPerimetro());
        ...
        System.out.println("El área del Circulo es: "+cir.calcularArea());
